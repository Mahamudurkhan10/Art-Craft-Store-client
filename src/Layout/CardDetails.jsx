...
const CardDetails = () => {
     ...
     return (
          <div>
          <div className="card bg-gray-100 w-3/5 mx-auto mt-4 h-[480px] hover:shadow-2xl card-compact p-3  shadow-sm">
                    <figure><img src={photo} className="size-[500px]" alt="Shoes" /></figure>
