...
const Footer = () => {
     return (
          <div className="mt-10">
               <footer className="px-4 divide-y dark:bg-gray-400 dark:text-gray-800">
                    <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                         <div className="lg:w-1/3">
                              <a rel="noopener noreferrer" href="/" className="flex justify-center space-x-3 lg:justify-start">
                                   <div className="flex items-center justify-center text-2xl text-blue-800">
                                        <FaChartPie></FaChartPie>
                                   </div>
                                   <span className="self-center text-2xl text-blue-900 font-semibold">Art & Craft Store</span>
                              </a>
                         </div>
